local homes_file = minetest.get_worldpath() .. "/homes2"
local homepos = {}
...
minetest.register_chatcommand("home2", {
    description = "Teleport you to your second home point",
    privs = {interact=true},
    func = function(name)
        ...
        if homepos[player:get_player_name()] then
            ...
            minetest.chat_send_player(name, "Set your second home using /sethome2")
        end
    end,
})

minetest.register_chatcommand("sethome2", {
    description = "Set your second home point",
    privs = {interact=true},
    func = function(name)
        local player = minetest.get_player_by_name(name)
